...
module.exports = {
  ...
  const utilitiesEmbed = new MessageEmbed()
    ...
    .setColor(Color)
    .addFields(
      { name: 'Utilities non-slash command', value: '`Avatar`, `GitHub`, `Lyrics`, `Meme`, `NSFW`, `Snipe`, `Weather`, `Screenshot`', },
  ...
  const infoEmbed = new MessageEmbed()
    ...
    .setDescription(Description)
    .addFields(
      { name: 'Non-Slash Commands', value: '`BotInfo`, `Ping`, `UserInfo`, `New`, `FirstMessage`', },
